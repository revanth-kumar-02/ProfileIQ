...
import { ImportStatus } from '../types/ingestion';
...
export const analysisStore = {
  ...
  setImportStatus(status: ImportStatus, error: string | null = null): void {
    this.setState({ importStatus: status, importError: error });
  },
